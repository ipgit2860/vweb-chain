...
type App struct {
	*baseapp.BaseApp
	...
	VnftKeeper vnftmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.VnftKeeper = *vnftmodulekeeper.NewKeeper(
		appCodec,
		keys[vnftmoduletypes.StoreKey],
		keys[vnftmoduletypes.MemStoreKey],
		app.GetSubspace(vnftmoduletypes.ModuleName),

		app.NftKeeper,
	)
	vnftModule := vnftmodule.NewAppModule(appCodec, app.VnftKeeper, app.AccountKeeper, app.BankKeeper)
...
func (app *App) registerUpgradeHandlers() {
	app.UpgradeKeeper.SetUpgradeHandler(UpgradeName, func(ctx sdk.Context, plan upgradetypes.Plan, fromVM module.VersionMap) (module.VersionMap, error) {
		...
		ctx.Logger().Info("*****************registerUpgradeHandlers**********")
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(vnftmoduletypes.ModuleName)
